...
public class Alert_template {
		...
		public String alertTemplatePage (ArrayList<Alert> listAlertsByONG)  {
			...
			for (Alert a : listAlertsByONG) {
				tableAlert += "<div style='border:1px solid black' name='alert' class='row mt-2 ml-2 mt-2 mp-2' value='"+ a.getId_alert()+"'>"
					...
					+ "</tr></thead> <tbody> <tr> <th scope='col' colspan='3' >"+ a.getProduct() +"</th> </tr> <tr> <th scope='col'>Comienzo fecha de entrega</th>"
					+ "<th scope='row'>Localización:</th>  <th scope='row'>*Alergenos</th></tr> <tr> <th scope='row'>"+ a.getDate_alert()+" </th><th scope='row'>"+ a.getPlace_alert()+" </th>  "
					+ "<th scope='row'>"+a.getAllergen_alert()+"</th></tr><tr><th scope='row' colspan='3'>*Especificaciones</th></tr> <tr> <th scope='row'>"+a.getAnnotation_alert()+"</th>"
					+ "<th scope='row'></th></tr><tr><th scope='row'></th>"
					+ "<th scope='row'></th><th scope='row'><input type='submit' name='btnDoDeleteAlert' class='btn btn-danger' value='Eliminar' formaction=\"Alerts_Controller\"/></th> </tr>"
